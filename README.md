...
**License:** Evaluation-Only (internal test/build allowed; no commercial use without permission) — see `LICENSE_EVALUATION_ONLY.md`
...
**Commercial/production use requires a separate license.** Evaluation use is permitted under the terms in `LICENSE_EVALUATION_ONLY.md`.
